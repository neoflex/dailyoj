...
grunt.initConfig({
  ...
  concat: {
    ...
    build: {
      files: [
      {src: ['app/bower_components/angular/angular.js','app/bower_components/angular-animate/angular-animate.js','app/bower_components/jquery/jquery.js','app/bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js'], dest: 'app/js/dependencies.js'},
